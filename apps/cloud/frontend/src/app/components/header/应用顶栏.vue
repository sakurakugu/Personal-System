        ...
        >
          ...
          <div class="header-right">
            ...
            <div
              ...
              class="dropdown-wrapper dropdown-wrapper--align-end theme-dropdown desktop-theme-dropdown"
            ...
            <div
              ref="plusDropdownRef"
              class="dropdown-wrapper dropdown-wrapper--align-end header-plus-dropdown"
