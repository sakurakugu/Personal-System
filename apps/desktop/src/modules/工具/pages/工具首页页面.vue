...
import { Connection, Crop, Monitor, Setting } from '@element-plus/icons-vue'
...
const 工具卡片列表 = [
  ...
  {
    标题: 'Windows 工具',
    描述: '收纳当前桌面端专属的 Windows 环境能力，先提供初始化预留和 Git 环境检测。',
    路径: '/tools/windows',
    图标: Monitor,
    标签: ['初始化', 'Git 检测', '桌面专属'],
    按钮文案: '进入 Windows 工具',
  ...
  <div class="tools-page">
    ...
    <section class="tools-note">
      <div class="tools-note__item">
        <Connection class="tools-note__icon" />
        <div>
          <h3>子路由拆分</h3>
          <p>图片工具和 Windows 工具都已拆成独立子路由，后续继续按类别扩展。</p>
        </div>
      </div>
      <div class="tools-note__item">
        <Setting class="tools-note__icon" />
        <div>
          <h3>桌面专属能力</h3>
          <p>Windows 工具仅在桌面端提供，用于承接本地环境检查和后续初始化流程。</p>
        </div>
      </div>
    </section>
  </div>
